...
typedef enum {
  QMI_ERROR_TYPE_MIN_ENUM_VAL = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  QMI_ERR_NONE = 0x0000,
  ...
  QMI_ERR_DEVICE_MEMORY_ERROR = 0x0072,
  QMI_ERR_NO_PERMISSION = 0x0073,
  QMI_ERR_TOO_SOON = 0x0074,
  QMI_ERR_TIME_NOT_ACQUIRED = 0x0075,
  QMI_ERR_OP_IN_PROGRESS = 0x0076,
  QMI_ERROR_TYPE_MAX_ENUM_VAL = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}QMI_ERROR_CODE_TYPE;
